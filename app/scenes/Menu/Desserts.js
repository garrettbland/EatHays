...
class Desserts extends Component {
  ...
  constructor(props) {
     ...
     if(this.props.menu.desserts.active === true){
       this.state = {
         dessertDataSource: ds.cloneWithRows(this.props.menu.desserts.items),
       };
     }
   }
    ...
    if(this.props.menu.desserts.active === false){
      ...
      return (
        <View style={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:'#e1e8ef'}}>
          ...
          <View>
            <Text style={{fontFamily:'oswald-bold',color:'#7f8c8d'}}>{randomWord[0]}. Currently no Desserts</Text>
          </View>
        </View>
      )
    }else{
